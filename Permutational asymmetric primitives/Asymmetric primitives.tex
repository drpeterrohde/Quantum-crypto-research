...
\begin{align}
	\frac{|\mathrm{Sym}(x)|}{|\mathrm{Aut}(x)|} = \frac{n!}{(\frac{n}{2})!(\frac{n}{2})!} = \binom{n}{n/2,n/2}.
\end{align}
...
%The one-way function from Eq.~\eqref{eq:one_way_sum} does not act distributively over $\oplus$,
%\begin{align}
%	(x\oplus y) &\xrightarrow{\pi} (x\oplus y)_\pi(x\oplus y)_{\pi^{-1}} \nonumber\\
%	&= x_\pi x_{\pi^{-1}} \oplus y_\pi y_{\pi^{-1}} \oplus x_\pi y_{\pi^{-1}} \oplus y_\pi x_{\pi^{-1}} \nonumber\\
%	&= \selfbraid{x}{\pi}{\pi^{-1}} \oplus  \selfbraid{y}{\pi}{\pi^{-1}} \oplus \braid{x}{y}{\pi}{\pi^{-1}} \oplus  \braid{y}{x}{\pi}{\pi^{-1}},
%\end{align}
%where,
%\begin{align}
%	\comm{x}{y}{\pi}{\pi^{-1}} \equiv \braid{x}{y}{\pi}{\pi^{-1}} \oplus \braid{y}{x}{\pi}{\pi^{-1}},
%\end{align}
