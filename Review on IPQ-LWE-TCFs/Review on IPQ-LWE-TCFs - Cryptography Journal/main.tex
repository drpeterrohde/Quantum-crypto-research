...
\begin{algorithm}[H]
	\begin{algorithmic}
        ...
        \State{$\mathbf{U}\in\mathbb{Z}^{m_2\times m_2}$, $\mathbf{R}\in\mathbb{Z}^{m_1\times m_2}$, $\mathbf{P}\in\mathbb{Z}^{m_2\times m_1}$ and $\mathbf{C}\in\mathbb{Z}^{m_1\times m_1}$ such that $\mathbf{U}$ is nonsingular and $(\mathbf{G}\mathbf{P}+\mathbf{C})\subset\mathcal{L}^{\perp}(\mathbf{A}_1)$.}
