...
\begin{center}
	\vspace{2pt}
	\resizebox{0.6\columnwidth}{!}{\input{figures/single_random_subset.tex}}
\end{center}
...
%\begin{center}
%	\includegraphics[width=0.9\columnwidth]{figures/bitcoin_energy_consumption.pdf}
%\end{center}
...
\begin{center}
	\resizebox{0.3\columnwidth}{!}{\input{figures/intro_bipartite.tex}}
\end{center}

\begin{center}
	\resizebox{0.3\columnwidth}{!}{\input{figures/intro_bipartite_rand.tex}}
\end{center}
...
\begin{center}
	\resizebox{0.8\columnwidth}{!}{\input{figures/network_accept.tex}}
\end{center}
...
\begin{center}
	\resizebox{0.5\columnwidth}{!}{\input{figures/proof_wedges.tex}}
\end{center}
...
\begin{center}
	\resizebox{0.4\columnwidth}{!}{\input{figures/QCN_intro.tex}}
\end{center}

\begin{center}
	\resizebox{0.9\columnwidth}{!}{\input{figures/quantum_random_oracle_intro.tex}}
\end{center}
...
\begin{center}
	\resizebox{0.75\columnwidth}{!}{\input{figures/bidding_market.tex}}
\end{center}

\begin{center}\emph{Blockchains}\end{center}

\begin{center}
	\resizebox{0.25\columnwidth}{!}{\input{figures/simple_blockchain.tex}}
\end{center}

\begin{center}\emph{Strategic trust dynamics}\end{center}

\begin{center}
	\resizebox{0.4\columnwidth}{!}{\input{figures/intro_forking.tex}}
\end{center}
