...
\begin{figure}[!htb]
	\centering
	\resizebox{0.5\columnwidth}{!}{\input{figures/compliance_voting.tex}} \\
	\vspace{-2em}
	\resizebox{0.32\columnwidth}{!}{\input{figures/compliance_voting_majority.tex}}
%	\hspace{1em}
	\resizebox{0.32\columnwidth}{!}{\input{figures/compliance_voting_minority.tex}}
	\resizebox{0.32\columnwidth}{!}{\input{figures/compliance_voting_indet.tex}}
