...
\begin{tikzpicture}
   \piechartthreed[scale=0.5, mix color=darkgray,shadowop=1,wedgeout=0]{60/green,60/green,60/red,60/green,60/green,60/red}
%   \begin{scope}[shift={(0,0.55)}]
%       \piechartthreed[scale=0.5, mix color=darkgray,shadowop=0,wedgeout=0]{60/green,60/green,60/red,60/green,60/green,60/red}
%    \end{scope}
