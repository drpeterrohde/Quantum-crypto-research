...
\begin{align}
	...
	\phi:&\, (s\soplus \mathcal{X}_i\soplus b_i, p\soplus \mathcal{X}_j\soplus b_j) \to (s\soplus p\soplus \mathcal{X}_j \soplus b_i \soplus b_j, p\soplus \mathcal{X}_j\soplus b_j),\nonumber
\end{align}
where $s\oplus p$ is public, the second bit is the control, and $\mathcal{X}_i\soplus\mathcal{X}_j$ is public, allowing the delegate to perform,
\begin{align}
