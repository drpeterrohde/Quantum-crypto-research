...
\begin{align}
	...
	&\sim \langle s\soplus \mathcal{X}_i,s\soplus \mathcal{X}_j \rangle \sim \langle \mathcal{X}_i,\mathcal{X}_j \rangle  \nonumber\\
	&\sim \mathrm{GF}(2^2),
\end{align}
where,
\begin{align}
...
let us instead encode $m$ against $p$,
 \begin{align}
	[p, m\soplus p \soplus \mathcal{X}_{i,j}].
\end{align}

Then the public and private groups are generated by,
\begin{align}
	G_\mathrm{priv} &\sim \langle s,p,m,\mathcal{X}_i,\mathcal{X}_j \rangle, \nonumber\\
	G_\mathrm{pub} &\sim \langle s\soplus \mathcal{X}_i, s\soplus \mathcal{X}_j, p\soplus m\rangle,
\end{align}
