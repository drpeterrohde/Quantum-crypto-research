...
\begin{tikzpicture}[genericStyle, scale=0.5]
    ...
    \node[draw=none, text=black] at (0,\labelY) {$\mathcal{X}_\mathcal{O}$};
    \node[draw=none, text=black] at (-\xoff,\labelY-\yoff) {$\mathcal{X}_\mathcal{N}$};
    \node[draw=none, text=black] at (\xoff,\labelY-\yoff) {$\mathcal{X}_\mathcal{N} \oplus \mathcal{X}_\mathcal{O}$};
