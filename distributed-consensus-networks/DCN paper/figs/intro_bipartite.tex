...
%         \node[draw=none, text=black] (labelG) at ($(a1.north)!0.5!(b1.north) + (0,0.45)$) {\Large $\mathcal{G}$};
         \node[draw=none, text=black] (labelN) at ($(a1) + (0,0.75)$) {\Large $\mathcal{N}$};
         \node[draw=none, text=black] (labelC) at ($(b1) + (0,0.75)$) {\Large $\mathcal{C}$};
    \end{tikzpicture}
%}